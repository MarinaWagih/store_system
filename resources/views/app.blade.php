    ...
    @if(Auth::user()->type=='admin')
        <div class="panel-default">
            <a class="collapsed"
               ...
               data-toggle="collapse"
               data-parent="#accordion"
               href="#collapseEmployees" aria-expanded="false"
               aria-controls="collapseModelType">
                <div class="color title3 panel_title" role="tab" id="headingModelType">
                    @lang('variables.employees')
                </div>
            </a>

            <div id="collapseEmployees"
                 class="panel-collapse collapse color"
                 role="tabpanel" aria-labelledby="headingModelType">
                <div class="panel-body title4">
                    <a role="button" href="{{ URL::action('EmployeeController@index') }}" class="dash_link">
                        @lang('variables.search')
                        <span class="glyphicon glyphicon-search"></span>
                    </a>
                    <br>
                    @if(Auth::user()->type=='admin')
                        <a role="button"  href="{{ URL::action('EmployeeController@create') }}" class="dash_link">
